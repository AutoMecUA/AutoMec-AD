...
def main():
    ...
    while  True:
        ...
        image_saved.save( data_path + '/IMG/' + image_name + '_L')

        # save image R
        
        img_rbg_R = cv2.resize(img_rbg_R, dim, interpolation = cv2.INTER_AREA)
        image_saved_R = Image_pil.fromarray(img_rbg_R)
        image_saved_R.save( data_path + '/IMG/' + image_name + '_R')
