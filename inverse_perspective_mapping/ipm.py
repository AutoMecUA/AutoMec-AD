#!/usr/bin/env python3
#
# Inverse perspective map (IPM) for bird's eye view by IPM
...
#
# v1.0.0 On 2021/10/02 by inaciose
#
...
def main():
    ...
    ipm_img = ipm.get_ipm_image(undistorted_image)
