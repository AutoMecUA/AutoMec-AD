...
void servo_cb( const std_msgs::Int16 & cmd_msg){
  ...
  //digitalWrite(LED_BUILTIN, HIGH-digitalRead(LED_BUILTIN));  //toggle led  
      //String readString = String(cmd_msg.data);
      //Serial.println(readString); //see what was received
      //str_msg.data = readString;
      
     
      // expect a string like 07002100 containing the two servo positions     
      //servo2 = readString.substring(0, 2); //get the first four characters
...
//ros::Publisher debug("debug", &str_msg);              //Defining the publisher
